  ...
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
      ...
      <ul class="navbar-nav me-auto mb-2 mb-lg-0">
        ...
        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?php echo $env["APP_URL"] . '/app/Views/SuperAdmin/users.php'; ?>">Usuarios</a>
        </li>

        <li class="nav-item">
          <a class="nav-link active" aria-current="page" href="<?php echo $env["APP_URL"] . '/app/Views/SuperAdmin/machines.php'; ?>">Maquinas</a>
        </li>
