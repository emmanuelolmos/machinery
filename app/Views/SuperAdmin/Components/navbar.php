    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarMachines">
            ...
            <ul class="navbar-nav me-auto" style="font-size: 18px;">
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $env["APP_URL"] . '/app/Views/SuperAdmin/users.php'; ?>">Usuarios</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $env["APP_URL"] . '/app/Views/SuperAdmin/machines.php'; ?>">Maquinas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $env["APP_URL"] . '/app/Views/SuperAdmin/templates.php'; ?>">Plantillas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $env["APP_URL"] . '/app/Views/SuperAdmin/maintenance.php'; ?>">Mantenimientos</a>
                </li>
            </ul>
