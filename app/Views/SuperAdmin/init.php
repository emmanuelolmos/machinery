...
<body>
    ...
    <div class="card shadow mx-5 mt-5">
        ...
        <div class="mt-5 mx-auto">
            <h1 class="fs-2">Bienvenido Super Administrador</h1>
        </div>
            ...
            <div class="row mx-5">
                ...
                <div class="col-md-4 mt-3 mb-3 mb-sm-0">
                    ...
                    <div class="card">
                        ...
                        <div class="card-header fs-5 text-white bg-primary text">Usuarios</div>

                        <div class="card-body text-center fs-1">

                            <div class="row mx-4">
                                <i class="bi bi-people-fill mt-2"></i>
                                <button onclick="redirectUsersPanel()" class="btn btn-primary mt-2">Ir al panel</button>
                            </div>
