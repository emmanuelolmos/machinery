    ...
    <div class="container-fluid">
        ...
        <div class="collapse navbar-collapse" id="navbarMachines">
            ...
            <ul class="navbar-nav me-auto" style="font-size: 18px;">
                ...
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $env["APP_URL"] . '/app/Views/Technical/templates.php'; ?>">Plantillas</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link" href="<?php echo $env["APP_URL"] . '/app/Views/Technical/maintenance.php'; ?>">Mantenimientos</a>
                </li>
            </ul>
